...
var backgroundSound,cannnonExplosionSound,pirateLaughSound,cannonWaterSound;
var balls = [];
var boats = [];
var score = 0;
var boatAnimation = [];
...
function preload() {
  ...
  cannnonExplosionSound = loadSound("./assets/cannon_explosion.mp3");
...
function keyReleased() {
  if (keyCode === DOWN_ARROW && !isGameOver) {
    ...
    cannnonExplosionSound.play();
    cannnonExplosionSound.setVolume(0.1);
  }
}
